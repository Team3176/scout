...
//
// Modded version for 3176, branched from 2451
...
function qr_regenerate() {
  ...
  matchLabel.innerText = "Match " + document.getElementById("input_m").value;
...
function qr_init() {
  // Find the "qr-table" element using its ID
  var qrTable = document.getElementById('qr-table');

  // Append the new div element to the "qr-table" element
  matchLabel = document.createElement('span');
  qrTable.appendChild(matchLabel);

// Create a new div element
  var newDiv = document.createElement('div');

// Append the new div element to the "qr-table" element
  qrTable.appendChild(newDiv);

  qr = new QRCode(newDiv, options)
}
